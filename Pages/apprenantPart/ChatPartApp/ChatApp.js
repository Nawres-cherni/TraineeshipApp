...
export default class ChatApp extends Component {
    ...
    setNewChatId = (newMessage) => {
        ...
        this.setState({ chatId: id }, () => {
            ...
            .then(() => firebase.firestore().collection('apprenants').doc(firebase.auth().currentUser.uid).update({
                chats: firebase.firestore.FieldValue.arrayUnion({
                    uid: firebase.auth().currentUser.uid,
                    chatId: this.state.chatId
                })
    ...
    saveColor = (color) => {
        ...
        this.RBSheet.close()
        firebase.firestore().collection('apprenants').doc(firebase.auth().currentUser.uid).update({
            bgColor: color
        }).then(() => {
            this.setState({
                saveColorLoading: false,
