...
{ image != null ? (
   ...
   >
       ...
       <LikeComment
        ...
        <>
        <View style={{ alignItems: 'center', justifyContent: 'space-between', flex: 1, padding: 5,marginTop:10 }} >
            <Text>
        ...
        return (
            <SafeAreaView>
                <FlatList
                    ...
                    renderItem={({ item }) =>
                    <TouchableRipple
                    onPress={() => this.props.navigation.push('PostDetailScreen', { postData: item,userName: this.props.nom_soc, userIconUrl: this.props.imageUrl })}
                    borderless={true}
