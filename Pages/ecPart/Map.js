  ...
  return (
    <View style={styles.container}>
      ...
      <MapView style={styles.map}
          ...
          zoomEnabled = {true}
      initialRegion={{
        latitude:Number(this.state.user.latitude),
        longitude:  Number(this.state.user.longitude),
      ...
      >
       ...
       onDragEnd={(direction) => this.setState(direction.nativeEvent.coordinate)}
        >
          ...
          >
          <Image source={{uri : this.state.user.imageUrl}}
...
/>
          ...
          <Marker
          coordinate={{ latitude: Number(this.state.user.latitude) 
            ,longitude: Number(this.state.user.longitude)}}
